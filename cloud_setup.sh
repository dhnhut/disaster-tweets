...
# # all `data` folder
# gdown https://drive.google.com/drive/folders/1crBCYyaLQChzxqGL2yxcVmdfu58TK0os?usp=drive_link -O ~/disaster-tweets/ --folder

# `splitted` folder
gdown https://drive.google.com/drive/folders/1ZqrGist-lMCW5Jg-VS6AcTftuz-T48t-?usp=drive_link -O ~/disaster-tweets/data/splitted --folder

# df_disaster_informative_knearest_0.75_100.csv
# gdown https://drive.google.com/file/d/1H5d2b2h7ace3uCR3Fkohw-1Wyk5oaf7t/view?usp=drive_link -O ~/disaster-tweets/data/disaster/

# df_weather_radius_0.75.csv
# gdown https://drive.google.com/file/d/1iXC8QT8xLqGl8uQ7Imgyydfe1cRIQyVp/view?usp=drive_link -O ~/disaster-tweets/data/extended/

# df_out_topic_knearest_0.6_top_100.csv
# gdown https://drive.google.com/file/d/1m43_waNzeiCzA1WpjYvMujO0CFsDQ2Yu/view?usp=drive_link -O ~/disaster-tweets/data/extended/
...
conda install datasketch transformers pytorch tqdm datasets scikit-learn python-dotenv matplotlib peft trl bitsandbytes evaluate sentence-transformers -y
